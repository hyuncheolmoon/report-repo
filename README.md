...
### 네비게이션 및 UI/UX
- 관리 페이지의 네비게이션 구조를 선택한 이유는 이후 설문지 내의 질문 유형 관리와 삭제된 페이지 관리 등 추가 기능을 위한 확장성을 고려하여 설계되었으나 완성하지 못했습니다.
- 반응형을 제공하지만 화면이 깨지지 않는 최소한으로만 제공됩니다. 
